...
void cholmod_test_1(FILE *inA, FILE *inB){
    cholmod_sparse* A;
...
void cholmod_test_2(FILE* inA, FILE* inB) {
    cholmod_sparse* A;
    cholmod_dense* X = NULL, * B, * W, * R = NULL;
    cholmod_factor* L;
    double* Bx, * Xx, * Rx;
...
void cholmod_test_3(FILE* inA, FILE* inB) {
    cholmod_sparse* A;
    cholmod_dense* X = NULL, * B, * W, * R = NULL;
    cholmod_factor* L;
    double* Bx, * Xx, * Rx;
...
int main() {
    ...
    printf("\n---------------------------------- cholmod_test_1:\n");
    cholmod_test_1(inA, inB);
    printf("\n---------------------------------- cholmod_test_2:\n");
    rewind(inA);
    rewind(inB);
    cholmod_test_2(inA, inB);
    printf("\n---------------------------------- cholmod_test_3:\n");
    rewind(inA);
    rewind(inB);
